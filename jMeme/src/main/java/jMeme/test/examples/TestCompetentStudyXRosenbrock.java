/*
 * TestCompetentStudyXRosenbrock.java 
 * 
...
import jMeme.problems.Rosenbrock.RosenbrockFitness;
...
/**
 * This class implements an example of competent design for the problem Rosenbrock.
 */
public class TestCompetentStudyXRosenbrock {
	...
	public static void main(String[] args) {
       ...
       RosenbrockFitness fRosenbrock=new RosenbrockFitness();
 		
         FitnessFeatures fitnessRosenbrock=new FitnessFeatures(fRosenbrock, FitnessFeatures.MIN);
       ...
       CompetentStudy proc=new CompetentStudy(pp, fitnessRosenbrock, 20, finC, gcc, lcc, new int[]{10,30,50}, new double[]{0.05, 0.5, 1.0}, new String[]{LocalOptimizerExecutor.BEST_SELECTION_SCHEME, LocalOptimizerExecutor.RANDOM_SELECTION_SCHEME, LocalOptimizerExecutor.STRATIFIED_SELECTION_SCHEME});
       proc.execute();
        
	
     //   GlobalOptimizationAlgorithmStudy proc1=new GlobalOptimizationAlgorithmStudy(pp, fitnessRosenbrock, 20, finC, gcc);
      //  proc1.execute();
        
       // LocalOptimizationAlgorithmStudy proc2= new LocalOptimizationAlgorithmStudy(pp, fitnessRosenbrock, finC, lcc);
       // proc2.execute();
	}
