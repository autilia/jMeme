/*
 * TestCompetentStudyXRastrigin.java 
 * 
...
import jMeme.problems.rastrigin.RastriginFitness;
import jMeme.problems.rastrigin.RastriginProblem;

/**
 * This class implements an example of competent design for the problem Rastrigin.
 */
public class TestCompetentStudyXRastrigin {
	...
	public static void main(String[] args) {
		...
		RastriginFitness fRastrigin=new RastriginFitness();
		
        FitnessFeatures fitnessRastrigin=new FitnessFeatures(fRastrigin, FitnessFeatures.MIN);
       ...
       CompetentStudy proc=new CompetentStudy(pp, fitnessRastrigin, 20, finC, gcc, lcc, new int[]{10,30,50}, new double[]{0.05, 0.5, 1.0}, new String[]{LocalOptimizerExecutor.BEST_SELECTION_SCHEME, LocalOptimizerExecutor.RANDOM_SELECTION_SCHEME, LocalOptimizerExecutor.STRATIFIED_SELECTION_SCHEME}, 20);
       proc.execute();
        
	
       // GlobalOptimizationAlgorithmStudy proc1=new GlobalOptimizationAlgorithmStudy(pp, fitnessRastrigin, 20, finC, gcc);
       // proc1.execute();
        
       // LocalOptimizationAlgorithmStudy proc2= new LocalOptimizationAlgorithmStudy(pp, fitnessRastrigin, finC, lcc);
      //  proc2.execute();
